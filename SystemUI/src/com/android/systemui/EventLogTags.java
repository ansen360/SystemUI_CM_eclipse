...
public class EventLogTags {
  ...
  public static final int SYSUI_LLS_KEYGUARD_SHOWING = 36060;

  /** 36061 sysui_lls_keyguard_dismissed (onLls|1) */
  public static final int SYSUI_LLS_KEYGUARD_DISMISSED = 36061;

  /** 36062 sysui_lls_notification_panel_shown (shown|1) */
  public static final int SYSUI_LLS_NOTIFICATION_PANEL_SHOWN = 36062;
  ...
  public static void writeSysuiLlsKeyguardShowing(int screenon) {
    android.util.EventLog.writeEvent(SYSUI_LLS_KEYGUARD_SHOWING, screenon);
  }

  public static void writeSysuiLlsKeyguardDismissed(int onlls) {
    android.util.EventLog.writeEvent(SYSUI_LLS_KEYGUARD_DISMISSED, onlls);
  }

  public static void writeSysuiLlsNotificationPanelShown(int shown) {
    android.util.EventLog.writeEvent(SYSUI_LLS_NOTIFICATION_PANEL_SHOWN, shown);
  }
